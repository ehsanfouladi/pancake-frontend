...
const Banner = () => {
    ...
    //                 >
    //                     {t('Create and manage your competitions.')}
    //                 </Text>

    //                 <Text bold mb="32px" maxWidth="520px" lineHeight="26.4px" fontSize={['16px', '16px', '16px', '24px']}>
    //                     {t('Easily create and manage your live competitions in user-friendly way.')}
    //                 </Text> */}
    //             </Flex>
    ...
    // )
    return (
        <Text textAlign='center' bold fontSize={['40px', '40px', '40px', '60px']} color="secondary" lineHeight="110%">
            {t('Competitions Administration')}
        </Text>
    )
}

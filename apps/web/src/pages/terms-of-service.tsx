...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">CadinuSwap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://apps.cadinu.io">
      ...
      <Text as="p">
        ...
        CadinuSwap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        <Link m="0 4px" display="inline !important" href="https://apps.cadinu.io/terms-of-service">
          https://apps.cadinu.io/terms-of-service.
        </Link>
        <Text as="span">
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. CadinuSwap does not control or operate any version of the Protocol on any blockchain
        ...
        CadinuSwap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        CadinuSwap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the CadinuSwap default token list and
        CadinuSwap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on CadinuSwap.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        potential dispute arises, you must contact us by sending an email to info@CadinuSwap.come so that we can
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by CadinuSwap, you will be solely responsible to

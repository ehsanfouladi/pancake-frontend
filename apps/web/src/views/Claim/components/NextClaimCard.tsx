...
const NextDrawCard = ({isSuccess, prizeAvailable}) => {
  ...
  const getTotalRewardClaimedByUsers = async () => {
      const fetchedTotalRewardClaimedByUsers = await client.readContract({
  ...
  const getTotalRewardPaidToUsers = async () => {
      const fetchedTotalRewardPaidToUsers = await client.readContract({
          address: claimContract.address as `0x${string}`,
          abi: claimADAbi,
  ...
  const getTotalClaim = async () => {
     const fetchedTotalClaim = await client.readContract({
        address: claimContract.address as `0x${string}`,
        abi: claimADAbi,
    ...
    const getAvailableReward = async () => {
      const fetchedAvailableReward = await client.readContract({
          address: claimContract.address as `0x${string}`,
          abi: claimADAbi,

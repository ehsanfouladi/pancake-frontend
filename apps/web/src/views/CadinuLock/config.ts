export const LOKCS_TO_SHOW = 10
export const ADMINS = [
  '0xd6A3340C99f2F0d89Bd956E9F8F1AECD2f598437', // DR.MACH
...
export const PANCAKE_SPACE = 'cadinuvote.eth'
export const VOTE_THRESHOLD = '100M'
...
import { Box, Dropdown, Flex, InputGroup, Radio, SearchIcon, SearchInput, Text, UserMenu, useMatchBreakpoints } from '@pancakeswap/uikit'
...
`
  ...
  const makeQuery = () => {
    let queryUrl =
      `${COMPETITION_V2_API_URL}/competitions?status=upcoming&chainId=${chainId}&page=${currentPage}`

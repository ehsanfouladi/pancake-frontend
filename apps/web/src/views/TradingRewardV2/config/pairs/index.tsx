...
import { ComputedFarmConfigV3, FarmSupportedChainId } from '@pancakeswap/farms/src'
import { ChainId } from '@pancakeswap/sdk'
import { tradingRewardV3Pair as tradingRewardV3Pair56 } from './56'

export const tradingRewardPairConfigChainMap: Record<FarmSupportedChainId, ComputedFarmConfigV3[]> = {

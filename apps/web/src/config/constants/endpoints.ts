...
export const API_PROFILE = 'https://api.cadinu.io'
export const API_NFT = 'https://api.cadinu.io/api/nft'
...
export const CADINU_ASSET = 'https://cadinu.io'
...
export const FARMS_API = 'https://farms.cadinu.io'
